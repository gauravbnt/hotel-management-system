...
public class BookingController {
    ...
    public ResponseEntity<SuccessResponse<BookingResponseDTO>> addBooking(
        ...
        SuccessResponse<BookingResponseDTO> response = new SuccessResponse<>(
    ...
    public ResponseEntity<SuccessResponse<BookingResponseDTO>> updateBooking(
            @RequestParam String roomNumber,
            @RequestParam String email,
            @Valid @RequestBody BookingRequestDTO bookingDTO) {

        logger.info("Updating booking for room: {}, email: {}", roomNumber, email);
        BookingResponseDTO updatedBooking = bookingService.updateBookingByRoomNumberAndEmail(roomNumber, email,
                bookingDTO);
