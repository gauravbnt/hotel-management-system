...
public class PaymentController {
    ...
    public ResponseEntity<SuccessResponse<PaymentResponseDTO>> createPayment(@Valid @RequestBody PaymentRequestDTO payment) {
    ...
    public ResponseEntity<SuccessResponse<PaymentResponseDTO>> getPaymentByTransactionId(@PathVariable String transactionId) {
    ...
    public ResponseEntity<SuccessResponse<PaymentResponseDTO>> updatePaymentByTransactionId(@Valid @RequestBody PaymentRequestDTO payment,@PathVariable String transactionId) {
